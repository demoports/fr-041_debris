...
//
// Generated by tools/oracles/bitmap_cell_oracle.cpp, a standalone transcription
// of genbitmap.cpp:2694. Ops 475 and 481 match that oracle byte for byte over
// all 2.6 MB. Op 452 differs in 35 of its 131,072 bytes, each by one step of
// `val`: it is the only one of the three whose amp and gamma actually reach
// sFPow, and sFPow (_types.cpp:393) is hand-written x87 assembly over fyl2x and
// f2xm1, so its last ulp is not reproducible from either powf or Math.pow. A
// double-precision build of the same oracle reproduces the pre-narrowing port
// output of all three exactly, which is what identified the sF32 locals below.
const savedTextureOffset = D.bitmapTextureSizeOffset;
const productionCellCases = [
  {
    operationId: 452, textureOffset: -2, dimensions: [128, 128], hash: 3173131776,
    sha256: 'a5018cfd7e459654ff4d42d9d7575807ff8c58b717355bb7c00d041b14fe6db5',
  },
  {
